...
extension API {
    func getTopRatedMovies(_ input: GetTopRatedMoviesInput) async throws -> GetTopRatedMoviesOutput {
        return try await request(input)
    }

    func getUpcomingMovies(_ input: GetUpcomingMoviesInput) async throws -> GetUpcomingMoviesOutput {
        return try await request(input)
    }

    func getMovieDetail(_ input: GetMovieDetailInput) async throws -> GetMovieDetailOutput {
        return try await request(input)
    }
}
